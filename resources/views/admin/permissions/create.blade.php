                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('New permission') }}</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
            ...
            <div class="row">
                <div class="mx-auto">
                    <form action="{{ route('admin.permissions.store') }}" method="POST" class="row g-3">
                        @csrf
                        <h6 class="mb-0 text-uppercase">{{ __('New permission') }}</h6>
                        <hr/>
                        ...
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-header">
                                <div class="card-title d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-primary">{{ __('New permission') }}</h5>
                                </div>
                            </div>
                            <div class="card-body row">
                                <x-forms.input-text idName="inputPermissionName" name="name" label="{{ __('Permission Title') }}" type="text" divClass="col-lg-3 col-md-6" value="{{ old('name') }}" helpText="{{ __('Permission title.') }}" />
                            </div>
                        </div>
                        <!-- ./card -->
